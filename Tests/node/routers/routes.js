...
const { index, registerContato, editIndex, editContato, deletContato }= require('../src/controllers/contatoController');
...
router.get('/contato/delete/:id', loggedUser, deletContato )
